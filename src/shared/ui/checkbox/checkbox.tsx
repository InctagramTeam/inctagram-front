      ...
      <>
        <div className={`_container_ flex items-center`}>
          ...
          >
            ...
            border-Light-500 bg-transparent p-[3px_1px] before:absolute before:left-1/2 before:top-1/2 before:-z-1 before:h-[32px]
            before:w-[32px] before:-translate-x-1/2 before:-translate-y-1/2 before:scale-0
