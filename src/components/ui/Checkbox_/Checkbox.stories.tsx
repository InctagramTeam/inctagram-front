...
const meta = {
  argTypes: {
    ...
    disabled: {
      control: 'boolean',
      description: 'Disables the Checkbox_ use',
    },
    label: {
      control: 'text',
      description: 'Set label for Checkbox_',
    },
    onCheckedChange: {
  ...
  parameters: {
    docs: {
      description: {
        component:
          'The Checkbox_ component is a customizable checkbox control with a label, utilizing Radix for styling. It supports properties like `checked`, `disabled`, and `label`, offering flexibility in checkbox appearance based on these props.',
      },
    },
    layout: 'centered',
  },
  tags: ['autodocs'],
  title: 'shared/Checkbox_',
