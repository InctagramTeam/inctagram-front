...
const SvgArrowForwardOutline = forwardRef<SVGSVGElement, SVGProps<SVGSVGElement>>(
...
const MemoSvgArrowForwardOutline = memo(SvgArrowForwardOutline)

export default MemoSvgArrowForwardOutline
